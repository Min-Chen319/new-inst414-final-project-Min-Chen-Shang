...
def transform_data(data_dict):
    ...
    if df_appointments.empty:
        print("Appointments dataset is empty.")
    if df_cms.empty:
        print("CMS dataset is empty.")
    ...
    if start_col and end_col:
        ...
        print("Could not find date columns to calculate lead_time.")
    ...
    if "no_show" in df_appointments.columns:
        ...
        print("Missing 'no_show' column in appointments data.")
    ...
    if missing_noshow == len(df_appointments):
        ...
        print(f"Dropping {missing_noshow} rows due to missing 'no_show' values.")
